<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_ManExc.aspx.cs" Inherits="MaxApp.frm_ManExc" %>
    ...
    <div class="main_container">
        ...
        <div class="main_data">
            <div class="data_header">
                ...
                <h5 class="data_titulo">Definir Excusas</h5>
            </div>
            <div class="data">
                <div class="data_body">
                    <div class="row">
                            ...
                            <div class="panel panel-default" id="panelLista" runat="server">
                                <div class="panel-heading">
                                    ...
                                    <asp:GridView ID="gv_Excusas" runat="server" CssClass="table table-striped table-bordered table-hover datatable"
                                        ...
                                        AutoGenerateColumns="false" DataKeyNames="AdmExcCodigo,AdmExcDescripcion,AdmstsCodigo">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Código">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fCodigo" runat="server" Text='<%# Eval("AdmExcCodigo")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Descripción">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fNombre" runat="server" Text='<%# Eval("AdmExcDescripcion")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:Button ID="ImageEdit" CssClass="btn btn-editar ic_lapiz" Text="Editar" runat="server" OnClick="EditarRegistro"  CommandArgument='<%# Eval("AdmExcCodigo")%>' Height="25px" />
                                                </ItemTemplate>
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <textarea id="txtDescripcionIniciativa" class="area100p-2row" placeholder="Escriba la descripción de la Excusa" runat="server" maxlength ="255"></textarea>
                                    </div>
                                    </div>
