<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_mantses.aspx.cs" Inherits="MaxApp.frm_mantses" %>
    ...
    <div class="main_container">
        ...
        <div class="main_data">
            <div class="data_header">
                ...
                <h5 class="data_titulo">Definir Tipos de Sesiones</h5>
            </div>
            <div class="data">
                <div class="data_body">
                    <div class="row">
                                   ...
                                   <asp:GridView ID="GridViewSesiones" runat="server" CssClass="table table-striped table-bordered table-hover datatable"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="#" HeaderStyle-Width="18%">
                                                <ItemTemplate>
                                                    <asp:Literal ID="IniTseCodigo" runat="server" Text='<%# Eval("IniTseCodigo")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Descripcion" HeaderStyle-Width="72%">
                                                <ItemTemplate>
                                                    <asp:Literal ID="IniTseDescripcion" runat="server" Text='<%# Eval("IniTseDescripcion")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:Button ID="ImageDelete" class="btn btn-editar ic_lapiz" Text="Editar" runat="server" OnClick="EditarRegistro" CommandArgument='<%# Eval("IniTseCodigo")%>' Height="25px" />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:Button ID="ImageVisualizar" class="btn btn-visualizar" Text="Ver" runat="server" OnClick="VisualizarRegistro" CommandArgument='<%# Eval("IniTseCodigo")%>' Height="25px" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                                            </asp:TemplateField>
                        ...
                        <div class="row m0">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtDescripcion" runat="server" CssClass="area100p-2row" placeholder="Escriba la descripción aquí"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
