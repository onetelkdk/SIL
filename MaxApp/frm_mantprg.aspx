<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_mantprg.aspx.cs" Inherits="MaxApp.frm_mantprg" %>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default" runat="server" id="panelLista">
                                <div class="panel-heading">
                                    <!-- Table Panel/////////// -->
                                    <asp:GridView ID="gv_Tipos" runat="server" CssClass="table table-striped table-bordered table-hover datatable" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No hay registros disponibles"
                                        AutoGenerateColumns="false" DataKeyNames="Id,PrgtipCodigo,PrgtipNombre,PrgTipDescripcion,PrgtipIcono,PrgtipOrden,AdmEstCodigo">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Código">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fCodigo" runat="server" Text='<%# Eval("PrgtipCodigo")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Nombre">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fNombre" runat="server" Text='<%# Eval("PrgtipNombre")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Icono">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fIcono" runat="server" Text='<%# Eval("PrgtipIcono")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Orden">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fOrden" runat="server" Text='<%# Eval("PrgtipOrden")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div class="panel-body shadow" runat="server" visible="true" id="PanelMantenimientos">
                        <div class="row m0">
                            ...
                            <div class="content">
                                ...
                                <div class="col-lg-3 col-md-4">
                                    <div class="form-group">
                                        <label>Orden</label>
                                        <asp:TextBox ID="txtOrden" runat="server" CssClass="text-240" />
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4">
                                    <div class="form-group">
                                        <label>Codigo / Referencia</label>
                                        <asp:TextBox ID="txtCodRef" runat="server" CssClass="text-240" />
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="row m0">
                            <div class="col-md-12">
                                ...
                                <textarea class="area100p-1row" id="txtDescripcion" runat="server" placeholder="Escriba la descripción de este tipo de programa"></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- End Div Fromularios ////////////////-->
