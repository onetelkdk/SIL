<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_manmexc.aspx.cs" Inherits="MaxApp.frm_manmexc" %>
    ...
    <div class="main_container">
        ...
        <div class="main_data">
            <div class="data_header">
                ...
                <h5 class="data_titulo">Motivos de excusas</h5>
            </div>
            <div class="data">
                <div class="data_body">
                    <div class="row">
