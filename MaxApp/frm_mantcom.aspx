<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_mantcom.aspx.cs" Inherits="MaxApp.frm_mantcom" %>
     ...
     <div class="main_container">
        ...
        <div class="main_data">
            <div class="data_header">
                ...
                <h5 class="data_titulo">Definir Tipo de Comisiones</h5>
            </div>
            <div class="data">
                <div class="data_body">
                    <div class="row">
                        ...
                        <div class="row m0">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="area100p-2row" placeholder="Escriba la descripción aquí"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
