<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMax.Master" AutoEventWireup="true" CodeBehind="frm_manmun.aspx.cs" Inherits="MaxApp.frm_manmun" %>
    ...
    <div class="main_container">
        ...
        <div class="main_data">
            <div class="data_header">
                ...
                <h5 class="data_titulo">Definir Municipios</h5>
            </div>
            <div class="data">
                <div class="data_body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default" id="panelLista" runat="server">
                                <div class="panel-heading">
                                    ...
                                    <asp:GridView ID="gv_Municipios" runat="server" CssClass="table table-striped table-bordered table-hover datatable"
                                        ShowHeaderWhenEmpty="true" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataText="No hay registros disponibles"
                                        AutoGenerateColumns="false" DataKeyNames="AdmMunCodigo,AdmMunDescripcion,AdmPrvCodigo,AdmStsCodigo">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Código">
                                                <ItemTemplate>
                                                    <asp:Literal ID="fCodigo" runat="server" Text='<%# Eval("AdmMunCodigo")  %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                <ItemTemplate>
                                                    <asp:Button ID="ImageEdit" CssClass="btn btn-editar ic_lapiz" Text="Editar" runat="server" OnClick="EditarRegistro"  CommandArgument='<%# Eval("AdmMunCodigo")%>' Height="25px" />
                                                </ItemTemplate>
                            ...
                            <div class="content">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="cboProvincia" runat="server" CssClass="select-240"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label>Nombre Municipio</label>
                                        <asp:TextBox ID="txtMunicipio" runat="server" CssClass="text-240" />
                                    </div>                               
                                </div>
